...
# flatten the grass texture (shapes conserve their original form)
flat = cv2.medianBlur(image, 21)

# distance from the grass color ("how not-grass is each pixel?")
...
# threshold using grass statistics (median + 8*MAD)
med = np.median(dist)
